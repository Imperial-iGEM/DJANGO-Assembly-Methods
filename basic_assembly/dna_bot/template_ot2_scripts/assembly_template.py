...
def run(protocol: protocol_api.ProtocolContext):
    def final_assembly(final_assembly_dict, tiprack_num,
                       ...
                       p10_mount='right', p10_type='p10_single',
        ...
        for key, values in list(final_assembly_dict.items()):
            ...
            for mag_bead_well in mag_bead_wells:
                ...
                pipette.aspirate(PART_VOL, mag_bead_well)
                pipette.move_to(destination_plate.wells_by_name()[key].top())
    ...
    final_assembly(final_assembly_dict=final_assembly_dict,
                   ...
                   p10_type=p10_type, mag_plate_type=mag_plate_type,
                   tube_rack_type=tube_rack_type,
